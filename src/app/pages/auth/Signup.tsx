...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#E6F1F0] via-[#F8FCFC] to-[#E6F1F0] flex items-center justify-center px-4 py-10 relative overflow-hidden">
      {/* Animated Background */}
      ...
      >
        ...
        >
          <Card className="p-6 sm:p-8 bg-white/80 backdrop-blur-xl border-[#80B9B6]/20 shadow-2xl shadow-[#00736D]/10 relative overflow-hidden">
            {/* Decorative Corner Gradient */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[#E6F1F0] to-transparent rounded-bl-full opacity-50 pointer-events-none" />
            ...
            <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
              ...
              <motion.div
                ...
                className="space-y-2"
              >
                <Label className="block text-xs font-bold text-[#002E2C] tracking-widest uppercase">
                  I am a
                </Label>
              ...
              >
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    required
                    className="pl-12 h-13 border-2 border-[#80B9B6]/20 focus:border-[#00736D] focus:ring-4 focus:ring-[#00736D]/10 rounded-xl bg-white/50 backdrop-blur-sm transition-all text-[#002E2C]/50 font-medium"
                  />
                </div>
              </motion.div>
              ...
              >
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full h-13 bg-gradient-to-r from-[#00736D] via-[#00736D] to-[#002E2C] hover:shadow-2xl hover:shadow-[#00736D]/30 hover:-translate-y-0.5 text-white font-bold text-base rounded-xl transition-all duration-300 relative overflow-hidden"
                >
                  <motion.div
            ...
            >
              ...
              >
                Sign In
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#00736D] transition-all group-hover:w-full" />
              </Link>
            </motion.p>
          </Card>
        </motion.div>
