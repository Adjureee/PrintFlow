        ...
        <div className="max-w-2xl mx-auto px-3 sm:px-4 py-3 sm:py-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="font-bold text-base sm:text-lg text-[#002E2C]">
                Print Settings
              </h1>
          ...
          <Card className="p-3 sm:p-4 bg-gradient-to-r from-[#E6F1F0] to-[#80B9B6]/30 border-2 border-[#80B9B6]/50 shadow-md">
            <div className="flex items-center gap-2 sm:gap-3 text-[#00736D]">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm text-[#00736D] font-semibold">
                  Printing at
                </p>
                <p className="font-bold text-sm sm:text-base text-[#002E2C] truncate">
                  {location.name}
                </p>
              </div>
            </div>
        ...
        >
          <Card className="p-4 sm:p-6 space-y-5 sm:space-y-6 shadow-lg border-2 border-[#80B9B6]/20">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-base sm:text-lg text-[#002E2C]">
                Print Options
              </h3>
            </div>
            ...
            <div className="space-y-2 sm:space-y-3">
              <Label className="text-sm sm:text-base font-bold text-[#002E2C]">
                Color Mode
              </Label>
              <RadioGroup
                value={settings.color}
                onValueChange={(value) =>
                  setSettings({ ...settings, color: value as "bw" | "color" })
                }
                className="space-y-2"
              >
                <motion.div
                ...
                >
                  <div
                    className={`flex items-center space-x-2 sm:space-x-3 p-3 sm:p-4 border-2 rounded-lg sm:rounded-xl cursor-pointer transition-all ${
                      settings.color === "bw"
                  ...
                  >
                    ...
                    <Label
                      htmlFor="bw"
                      className="flex-1 cursor-pointer flex justify-between items-center gap-2 min-w-0"
                    >
                      <div className="min-w-0 flex-1">
                        <span className="font-semibold text-sm sm:text-base text-[#002E2C] block">
                          Black & White
                        </span>
                      ...
                      <div className="text-right flex-shrink-0">
                        <span className="text-base sm:text-lg font-bold text-[#00736D] block">
                          Γé▒5
                        </span>
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              >
                {[
                  ...
                  >
                    <div
                      className={`relative p-3 sm:p-4 border-2 rounded-lg sm:rounded-xl cursor-pointer transition-all ${
                    ...
                    >
                      ...
                      >
                        <p className="font-semibold text-xs sm:text-sm text-[#002E2C]">
                          {option.label}
                        </p>
            ...
            <div className="space-y-2 sm:space-y-3">
              <Label
                htmlFor="copies"
                className="text-sm sm:text-base font-bold text-[#002E2C]"
              >
                Number of Copies
              </Label>
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <Button
                  ...
                  onClick={() =>
                    setSettings({
                      ...settings,
                      copies: Math.min(100, settings.copies + 1),
                    })
                  }
                >
          ...
          <Card className="p-4 sm:p-6 space-y-4 sm:space-y-6 shadow-lg border-2 border-[#80B9B6]/20">
            ...
            <div className="bg-gradient-to-r from-[#00736D] to-[#002E2C] rounded-xl sm:rounded-2xl p-5 sm:p-6 text-white text-center shadow-xl">
              ...
              <p className="text-[10px] sm:text-xs opacity-75 mt-2 break-words px-2">
                ...
                ΓÇó {settings.color.toUpperCase()} ΓÇó{" "}
            ...
            <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-xl sm:rounded-2xl p-4 sm:p-6">
              <p className="text-center font-semibold mb-3 sm:mb-4 text-sm sm:text-base text-[#002E2C]">
                Scan with GCash App
              </p>
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <p className="text-[10px] sm:text-xs text-gray-600 flex items-start gap-1.5 sm:gap-2">
                ...
                <span>
                  You can find this 13-digit reference number on your GCash
