// Mock data store for PrintFlow orders
// In production, this would be replaced with Supabase or another backend

export type OrderStatus = 'pending' | 'awaiting-verification' | 'processing' | 'printing' | 'ready' | 'completed';
...
export const orderStore = {
  ...
  createOrder: (order: Omit<Order, 'id' | 'createdAt' | 'claimCode'>): Order => {
